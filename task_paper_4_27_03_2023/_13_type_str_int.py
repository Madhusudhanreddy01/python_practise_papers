...
• Scenario 1: If the argument provided is a list then, Print inside the function 
as“valid argument “
• Scenario 2: if the argument provided is a different data type, then 
Print a message saying “ invalid argument, You have provided data type (str/int) .'''
